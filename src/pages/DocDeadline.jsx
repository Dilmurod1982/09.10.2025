...
const DocDeadline = () => {
  ...
  const fetchData = async () => {
    try {
      // 🔹 Загружаем типы документов и фильтруем только с validity: "expiration"
      ...
      const typesData = typesSnap.docs
        ...
        .filter((type) => type.validity === "expiration"); // 🔹 ФИЛЬТРАЦИЯ
          ...
          <div className="text-center py-12">
            <div className="bg-white rounded-2xl shadow-md p-8 max-w-md mx-auto">
              ...
              <p className="text-gray-500">
                Все документы имеют неограниченный срок действия или еще не
                добавлены.
              </p>
            </div>
          </div>
