...
import { AddDocumentModalByTypeInf } from "../components";
import DocumentTableInf from "../components/DocumentTableInf";

const DocumentPageInf = () => {
  const { id } = useParams();
...
export default DocumentPageInf;
